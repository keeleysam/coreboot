...
static const struct pad_config gpio_table[] = {
	...
	PAD_CFG_NF(GPP_B14, NONE, PLTRST, NF4),	/* SATA_LED# */
	...
	PAD_CFG_NF(GPP_A12, NONE, DEEP, NF1),	/* SATAXPCIE1 */
	...
	PAD_CFG_NF(GPP_A17, NONE, DEEP, NF4),	/* DISP_MISCC */
	...
	PAD_CFG_GPI_SCI(GPD2, NONE, DEEP, LEVEL, INVERT),	/* LAN_WAKE# */
	...
	PAD_CFG_NF(GPP_E14, NONE, PLTRST, NF1),	/* DDSP_HPDA */
	...
	PAD_NC(GPP_E20, NATIVE),	/* GPIO */
	PAD_NC(GPP_E21, NATIVE),	/* GPIO */
